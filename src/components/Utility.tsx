...
const Utility = () => {
  return (
    <div>
      <div>
        <h3 className=" font-paladins-straight  text-[40px] text-[#F01E31] text-center lg:text-left">
          Utility
        </h3>

        <div className=" w-[80%] mx-auto  flex flex-col lg:flex-row justify-between gap-[40px] lg:gap-0">
